package com.waitless.reservation.infrastructure.config.kafka;
...
public class KafkaConfig {
    ...
    private DefaultErrorHandler customErrorHandler() {
        DefaultErrorHandler handler = new DefaultErrorHandler((record, exception) -> {
            log.error("[Kafka Exception] topic = {}, value = {}, error message = {}", record.topic(),
                    record.value(), exception.getMessage());
        }, new FixedBackOff(1000L, 2L)); //1초 2번
